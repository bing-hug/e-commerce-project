...
import imgZoom from '@/pages/Detail/Zoom/imgZoom.vue'
...
<!--          &lt;!&ndash;放大镜效果&ndash;&gt;-->
          <imgZoom :skuImageList="skuInfo.skuImageList || []"/>
          <!-- 小图列表 -->
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model.number="goodCount" readonly>
                <a href="javascript:" class="plus" @click="goodCount++">+</a>
